...
def notified1():
    ...
    pygame.mixer.music.load('S1/notified1.mp3')  # Replace 'S1/notified1.mp3' with your actual file path
...
alert_button.grid(row=0, column=2, padx=10, pady=5)
